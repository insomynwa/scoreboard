...
<body>
  ...
  <div id="scoreboard-area">
    ...
    <form id="form-scoreboard" action="controller.php" method="post">
        ...
        <br>
        <input type="radio" name="scoreboard_gamemode" class="scoreboard-gamemode-cls" value="0" id="scoreboard-gamemode-team" checked="checked"> Team Game | 
        <input type="radio" name="scoreboard_gamemode" class="scoreboard-gamemode-cls" value="1" id="scoreboard-gamemode-single"> Single
        <br>
        <label for="scoreboard_team_a">Team A:</label>
        <select name="scoreboard_team_a" id="scoreboard-team-a" class="scoreboard-team-cls"></select>
        <div class="scoreboard-player-area-cls hide">
            <label for="scoreboard_player_a">Player A:</label>
            <select name="scoreboard_player_a" id="scoreboard-player-a" class="scoreboard-player-cls"></select>
        </div>
        <br><span>vs</span><br>
        <label for="scoreboard_team_b">Team B:</label>
        <select name="scoreboard_team_b" id="scoreboard-team-b" class="scoreboard-team-cls"></select>
        <div class="scoreboard-player-area-cls hide">
            <label for="scoreboard_player_b">Player B:</label>
            <select name="scoreboard_player_b" id="scoreboard-player-b" class="scoreboard-player-cls"></select>
        </div>
        <br>
