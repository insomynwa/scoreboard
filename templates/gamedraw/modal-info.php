    ...
    <div class="modal-dialog">
        <div class="modal-content bg-gray-1">
            ...
            <div class="modal-header border-gray-5">
                <h4 id="gamedraw-info-modal-title" class="modal-title text-warning">Game Info</h4>
                <button type="button" class="close text-gray-4 modal-close-btn" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal body -->
            <div class="modal-body">
                <div id="gamedraw-summary"></div>
                <button type="button" id="gamedraw-summary-print" class="btn btn-sm btn-link-gray-4">
