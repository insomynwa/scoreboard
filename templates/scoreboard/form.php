    ...
    <table class="table table-sm">
        ...
        <tbody>
            <tr>
                ...
                <td class="form-scoreboard-score1 score-field <?php echo $style_config['score1']['visibility_class']; ?>"><input type="text" class="form-control score-a-input-cls" name="score_a_pt1" id="score-a-pt1" value="<?php echo $contestants[0]['score_1']; ?>"></td>
                <td class="form-scoreboard-score2 score-field <?php echo $style_config['score2']['visibility_class']; ?>"><input type="text" class="form-control score-a-input-cls" name="score_a_pt2" id="score-a-pt2" value="<?php echo $contestants[0]['score_2']; ?>"></td>
                <td class="form-scoreboard-score3 score-field <?php echo $style_config['score3']['visibility_class']; ?>"><input type="text" class="form-control score-a-input-cls" name="score_a_pt3" id="score-a-pt3" value="<?php echo $contestants[0]['score_3']; ?>"></td>
                <td class="form-scoreboard-score4 score-field <?php echo $style_config['score4']['visibility_class']; ?>"><input type="text" class="form-control score-a-input-cls" name="score_a_pt4" id="score-a-pt4" value="<?php echo $contestants[0]['score_4']; ?>"></td>
                <td class="form-scoreboard-score5 score-field <?php echo $style_config['score5']['visibility_class']; ?>"><input type="text" class="form-control score-a-input-cls" name="score_a_pt5" id="score-a-pt5" value="<?php echo $contestants[0]['score_5']; ?>"></td>
                <td class="form-scoreboard-score6 score-field <?php echo $style_config['score6']['visibility_class']; ?>"><input type="text" class="form-control score-a-input-cls" name="score_a_pt6" id="score-a-pt6" value="<?php echo $contestants[0]['score_6']; ?>"></td>
                <td class="form-scoreboard-setpoint <?php echo $style_config['setpoint']['visibility_class']; ?>"><input type="text" class="form-control " name="score_a_setpoints" id="score-a-setpoints" data-setpoints="0" value="<?php echo $contestants[0]['set_points']; ?>"></td>
                <td class="form-scoreboard-setscore <?php echo $style_config['setscore']['visibility_class']; ?>"><input type="text" class="form-control " readonly name="score_a_total" id="score-a-total" value="<?php echo $contestants[0]['set_scores']; ?>"></td>
                <td class="form-scoreboard-gamepoint <?php echo $style_config['gamepoint']['visibility_class']; ?>"><input type="text" class="form-control " readonly name="score_a_gamepoints" id="score-a-gamepoints" data-gamepoints="0" value="<?php echo $contestants[0]['game_points']; ?>"></td>
                <td class="form-scoreboard-gamescore <?php echo $style_config['gamescore']['visibility_class']; ?>"><input type="text" class="form-control " readonly name="score_a_gametotal" id="score-a-gametotal" value="<?php echo $contestants[0]['game_scores']; ?>"></td>
    ...
    <table class="table table-sm">
        ...
        <tbody>
            <tr>
                ...
                <td class="form-scoreboard-score1 <?php echo $style_config['score1']['visibility_class']; ?>"><input type="text" class="form-control score-b-input-cls" name="score_b_pt1" id="score-b-pt1" value="<?php echo $contestants[1]['score_1']; ?>"></td>
                <td class="form-scoreboard-score2 <?php echo $style_config['score2']['visibility_class']; ?>"><input type="text" class="form-control score-b-input-cls" name="score_b_pt2" id="score-b-pt2" value="<?php echo $contestants[1]['score_2']; ?>"></td>
                <td class="form-scoreboard-score3 <?php echo $style_config['score3']['visibility_class']; ?>"><input type="text" class="form-control score-b-input-cls" name="score_b_pt3" id="score-b-pt3" value="<?php echo $contestants[1]['score_3']; ?>"></td>
                <td class="form-scoreboard-score4 <?php echo $style_config['score4']['visibility_class']; ?>"><input type="text" class="form-control score-b-input-cls" name="score_b_pt4" id="score-b-pt4" value="<?php echo $contestants[1]['score_4']; ?>"></td>
                <td class="form-scoreboard-score5 <?php echo $style_config['score5']['visibility_class']; ?>"><input type="text" class="form-control score-b-input-cls" name="score_b_pt5" id="score-b-pt5" value="<?php echo $contestants[1]['score_5']; ?>"></td>
                <td class="form-scoreboard-score6 <?php echo $style_config['score6']['visibility_class']; ?>"><input type="text" class="form-control score-b-input-cls" name="score_b_pt6" id="score-b-pt6" value="<?php echo $contestants[1]['score_6']; ?>"></td>
                <td class="form-scoreboard-setpoint <?php echo $style_config['setpoint']['visibility_class']; ?>"><input type="text" class="form-control " name="score_b_setpoints" id="score-b-setpoints" data-setpoints="0" value="<?php echo $contestants[1]['set_points']; ?>"></td>
                <td class="form-scoreboard-setscore <?php echo $style_config['setscore']['visibility_class']; ?>"><input type="text" class="form-control " readonly name="score_b_total" id="score-b-total" value="<?php echo $contestants[1]['set_scores']; ?>"></td>
                <td class="form-scoreboard-gamepoint <?php echo $style_config['gamepoint']['visibility_class']; ?>"><input type="text" class="form-control " readonly name="score_b_gamepoints" id="score-b-gamepoints" data-gamepoints="0" value="<?php echo $contestants[1]['game_points']; ?>"></td>
                <td class="form-scoreboard-gamescore <?php echo $style_config['gamescore']['visibility_class']; ?>"><input type="text" class="form-control " readonly name="score_b_gametotal" id="score-b-gametotal" value="<?php echo $contestants[1]['game_scores']; ?>"></td>
